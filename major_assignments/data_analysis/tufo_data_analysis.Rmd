...
Answer: 20772 has the highest number of foreclosures for 2022

will use datawrapper for this

** FOR 2022 FEBRUARY IS MISSING
...
```{r}
md_foreclosure_data_wzip <- md_foreclosure_data %>% 
  group_by(Zip) %>% 
  mutate(Zip_total = `March 2022` + `April 2022` + `May 2022` + `June 2022`+ `July 2022` + `August 2022` + `September 2022` + `October 2022` + `November 2022` + `December 2022` + `January 2022` + `February 2020`) %>%
  arrange(desc(Zip_total))

write.csv(md_foreclosure_data_wzip, file='data/md_foreclosure_data_wzip.csv')
