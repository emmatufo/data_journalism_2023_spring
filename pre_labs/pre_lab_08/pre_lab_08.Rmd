...
**Answer Make a new dataset, Label = TRUE gives a nice abbreviation of the month, rather than the number, group by month, so that's what you see, then you find the total number of calls for each month.**
...
**Answer a grey box!! ggplot gives a place to draw things on**
...
**Task** Run the following code. Explain what you see after running the code in the space below.
**Answer I see a bar graph of the total calls ber month**
...
**Answer The bar graph, but reordered from lowest # of calls to highest.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer Makes graph horizontal. Flips axis**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer does away with grey background - makes some stylistic differences**
...
**Answer background is a blueish color, font style is a bit different**
```{r}
baltco_911_calls_by_month %>%
  ggplot() +
  geom_bar(aes(x=reorder(month,total_calls), weight=total_calls)) +
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer adds title, adds labels that are actual words/phrases to x and y axis**
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer number of calls per date**
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer a line chart - i find these hard to dissect, but you are able to see spikes and decreases easily.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer all if the dates at the bottom are overlapping**
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer the dates are diagonal, it's slightly less bad, but readable**
```{r}
baltco_911_calls_by_date %>%
  ggplot() + 
  geom_line(aes(x=date, y=total_calls)) + 
