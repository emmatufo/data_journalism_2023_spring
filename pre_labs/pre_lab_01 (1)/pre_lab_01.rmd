...
**Answer 55,632 obs of 7 variables**
...
**Answer number of classes based on term**
...
**Answer i TOOK AWAY THE DESC, it;s the number of classes per term from least to greatest now**
...
**Answer it is grouped by term and department. the group by (term, department) allows for the number of each classes for each department in a specific term to be shown.**
...
Compared to the previous codeblock, what has changed and how did that affect the result? 
**Answer there are more columns of data - the total seats per term was added**
...
**Answer there are more columns, more information to sort by (mean of the number of seats, median of the number of seats**
...
**Answer the min and max seats for each course was added as columns - more information to sort by**
...
1.  Which department has the least courses this semester?

2.  Which department has the largest class size (most seats) per class?

3.  Average amount of seats in classes across all departments?
