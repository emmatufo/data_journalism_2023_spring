...
```{r echo=FALSE}
census_api_key("93ac7214d7ec10e5c9ada6bbcd618b4eacdaffd3", install=TRUE)
```
...
Is the difference between Calvert and Montgomery significant? **Answer No, very close**

Is the difference between Howard and everyone else significant? **Answer Yes, there's a notable difference between Howard County and everyone else.**
...
**Answer People were getting money from relief programs during pandemic and gentrification.  **
...
**Answer High school might not be in zip code someone permanently lives in, which may make this harder to interpret. Relationship between average household data and enrollment percentages?**
...
**Answer The average income for high schools that have 60% or more graduates immediately enrolling in college is 111448.3 and for those with less than 40% is 69252.24. There's a fairly substantial difference in those sending their kids to college in high income areas, to low income.**
...
**Answer Where might there be high enrollment perecentages, but low average household income? which HS has highest enrollment percentage? ** 
