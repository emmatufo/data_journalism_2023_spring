...
select carves off columns "I only want to see these things"
...
^Shakespeare would mean shakespeare is the first word 
...
**Answer It's the first day in each month. **
...
**Answer It is adding a percentage column for wes moore. It is based on the given data. Moore's votes/Total votes in each area**
...
**Answer the mutation "*100" changed pct moore from a decimal point to whole numbers**
...
**Answer I think so, it shows where he got the least percentage of votes right at the top**
...
**Answer str_to_title, str_to_sentence**
...
**Answer Yes, but I'm kind of unclear as to what the total is exactly a total of. I could just be reading over it though. **
...
1. Which computer science courses have less than 30 seats?

2. Which journalism courses do you need prequisites for?

3. Are there any social media classes offered at UMD this semester?
