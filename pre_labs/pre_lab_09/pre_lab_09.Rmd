...
**Answer https://www.datawrapper.de/_/I9f0i/** Copy the url of the graphic you published here. It will begin with https://datawrapper.dwcdn.net/. Don't copy the browser's current url.
...
**Answer Rather than seeing the entire US, it shows just MD, for that's the only place where the data is from.** Describe the changes from the previous map
...
**Answer Rather than seeing the zip and a 15 digit decimal, you now see the name of the county and a decimal rounded to the nearest tenth.** Describe the changes from the previous map
...
**Answer** https://www.datawrapper.de/_/1sKpf/.
