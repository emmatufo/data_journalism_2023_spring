...
**Task** Run the following code to group and count records in the Grantee column, and filter to examine only recipients that start with W. Name a problem that you see that is preventing proper grouping. **Answer There are grantees that are probably the same thing, but separated by a small difference. For example, WASHINGTON COUNTY COMMUNITY ACTION COUNCIL and WASHINGTON COUNTY COMMUNITY ACTION COUNCIL INC are probably the same thing, separated into different by 'inc'**
...
**Answer Washington County Museam of Fine Arts -> gets capitalized to WASHINGTON COUNTY MUSEUM OF FINE ARTS - Avalon Foundation, Inc. -> AVALON FOUNDATION INC**
...
**Task** Run the following code to group by grantee_clean and Grantee, then filter for recipients that start with W. Name three changes the refinr function made in the first 30 results. **Answer On mine i am not seeing any differences except WASHINGTON ADVENTIST UNIVERSITY -> Washington Adventist University I think something went wrong**
...
**Answer not very substantial, does get Washington County Community Action Council**
