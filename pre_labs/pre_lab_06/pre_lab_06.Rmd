...
**Answer At first what stood out to me was how from 2018 to 2020, the libertarian party went from 1340 people to 926, then back up to 1180 in 2022. Im just curious what caused the mass decline, as we don't see a decline as drastic for any other party. ** 
...
**Task** Create a new dataframe with population and voter data joined together. Add a description of what this code does to your reference notebook. Its the same code as task 7, assigned with a new name, joimed with "by=join_by(COUNTY). BUT do task 7. rather that 8
...
**Answer Counts of each race, age for each county** 
...
**Answer Somerset - they're almost equal**
...
**Answer Montgomery County. These results are different because the pct_asian_18_plus has much smaller percentages from pct_black_18_plus, but still high percentages in pct_dems. You also see a mojority of Asians in Maryland in only 2 counties, which is different from task 11, where African Americans were more spread out among the state. **
