...
**Answer reads in press releases, but has 4 columns instead of 3, with the fourth being hte text of the press releases**
...
**Answer shows the unique values no matter how many times they appear**
...
**Answer shows unique word for each speech but some aren't too unique **
...
**Answer graph of how many of each unique word is used**
...
**Answer shows stuff, excluding from stop_words, showing what's different, counts how many times each shows up, and creates a percentage of the whole for top 50**
...
**Answershows words for each, excluding from stop_words, showing what's different, counts how many times each shows up, and creates a percentage of the whole for top 10, 2021 is a about Covid-19, 2022 is about rebuilding communities, 2023 involves women, rights, projects **
...
**Task** Run the following code and describe the results.
**Answer the words go from 1 to 2 word phrases, counts how many times the phrase shows up, and its percent of the whole for the top 10. covid-19 still shows up which is different from the single word lists. now, a lot about funding and doing stuff**
...
**Task** Run the following code and describe the results.
**Answer finds the phrases that show up the most prior to january 1st, 2023 and after january 1, 2022 the amount they appear and their percentage of the whole for top 10.**
...
**Task** Run the following code and describe the results.
**Answer for 2023, finds phrases thar appear the most, the amount they appear and their percent of a whole. first time we are seeing oral health which is weird**
...
**Answer. applies sentiment to the unique words, counts the amount of times it shows up. they seem pretty accurate **
