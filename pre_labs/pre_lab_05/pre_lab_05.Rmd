...
**Answer Maryland's data is put as the column names**
...
**Answer Maryland is now first line of data, but there are substitutes for column names. There are also no longer commas**
...
**Answer Get rid of the periods next to each jurisdiction**
