...
**Answer The column that was weird is the multipolygon - a new datatype we haven't seen that before**
...
**Answer The shape/size of every maryland county by latitude&longitude measurements**
...
**Answer Zip code based map - shows a map of maryland by zip code - boundaries based on longitude and latitude**
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer Makes super accurate maps directly from census bureau**
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer Loads data for all counties in US**
```{r}
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer filters to just Maryland counties**
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer County map of Maryland, but doesn't show the Chesapeake so it's distorted**
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer layers county boundaries with zip code boundaries. some counties include water, zip codes do not, so there's different boundaries**
put one with least amount of stuff first
counties---zip codes--- trees
...
**Task** Run the following code. Describe the output in the space below.
**Answer joins the zip code data with the foreclosure data**
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer Map by color -- lighter colors have more foreclosure notices --- dark have less**
...
**Answer Loads libraries and census api key **
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer you get two new dataframes: county notices -> number of notices in each jurisdiction in march 2023 | county population -> population per county**
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer geometry=TRUE gives geometry column for free**
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer shows each dataframe to find out what needs to be cleaned**
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer cleans the county population data, renames column to county and changes the county value to remove , Maryland**
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer joins the two dataframes, making a new dataframe with the pop data and foreclosure data**
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer new column calculating the rate of foreclosure per 1000 population of county**
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer map form --- rate of foreclosure per 1000 population in each county --- lighter colors have higher rates**
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer different color fill distinguishing differences between rates in each county --- wider variety of colors makes it easier to see differences**
...
**Answer adds a log scale ---> distinguishes differences between each county even more**
