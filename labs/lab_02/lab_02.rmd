...
**A3.It's pretty interesting that in the economics department, there's a class with climate in the title. I just wouldn't expect it, that's why it's most interesting to me.** 
...
**A4. Over time, spending is increasing**
...
Question: How many computer science courses have at least 30 seats?
**A5.754** 

```{r}
computer_science_seats_30 <- umd_courses %>% filter(department == "Computer Science") %>% filter(seats >= 30)

nrow(computer_science_seats_30)
```
